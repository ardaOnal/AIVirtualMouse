# AIVirtualMouse
AI based virtual mouse where the camera detects your hand and it is used as a mouse. OpenCV and Mediapipe libraries were used. Check out below images for more details.
